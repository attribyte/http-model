...
/**
 * Builds immutable HTTP {@code GET} requests.
 */
public class GetRequestBuilder extends RequestBuilderWithParameters {

   /**
    * Creates a {@code GET} request builder with URI parsed from a string and
   ...
   /**
    * Creates a {@code GET} request builder with URI parsed from a string with parameter case-sensitivity specified.
    * @param uri The URI string to be parsed.
    * @param caseSensitiveParameters Should case be preserved for URI parameter names?
    * @throws InvalidURIException if URI is invalid.
    */
   public GetRequestBuilder(final String uri, final boolean caseSensitiveParameters) throws InvalidURIException {
   ...
   /**
    * Creates a {@code GET} request builder with parameter case-sensitivity specified.
    * @param uri The URI.
    * @param caseSensitiveParameters Should case be preserved for URI parameter names?
    */
   public GetRequestBuilder(final URI uri, final boolean caseSensitiveParameters) {
      super(uri, caseSensitiveParameters);
      String qs = this.uri.getQuery();
      if(qs != null) {
         this.parameters.putAll(Request.parseParameters(qs, caseSensitiveParameters));
   ...
   /**
    * Creates a {@code GET} request builder with URI parsed from a string.
    * <p>
   ...
   /**
    * Creates a {@code GET} request builder.
    * <p>
    * Case is preserved for parameter names.
    * </p>
    * @param uri The URI string to be parsed.
